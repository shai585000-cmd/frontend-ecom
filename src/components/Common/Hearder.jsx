        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <nav className="hidden lg:flex items-center space-x-8">
                  ...
                  <div className="absolute top-full left-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-100 py-2 z-50">
                    {productCategories.map((cat) => (
                      <Link
                        ...
                        className="block px-4 py-2.5 text-gray-700 hover:bg-orange-50 hover:text-orange-500 transition-colors"
                      >
                        {cat.name}
                      </Link>
                    ))}
              ...
              <Link to="/a-propos" className="text-gray-700 hover:text-orange-500 font-medium transition-colors">
                À propos
              </Link>
              ...
              {isAuthenticated ? (
                <div className="relative" ref={profileMenuRef}>
                  <button
                    ...
                    className="flex items-center gap-2 p-2 text-gray-600 hover:text-orange-500 transition-colors"
                  >
                    <User size={22} />
                    ...
                    <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-100 py-2 z-50">
                      ...
                      <div className="py-1">
                        <Link
                          ...
                          className="flex items-center gap-3 px-4 py-2.5 text-gray-700 hover:bg-orange-50 hover:text-orange-500 transition-colors"
                        >
                          <User size={18} />
                          Mon profil
                        </Link>
                ...
                <Link
                  to="/login"
                  className="hidden md:flex items-center gap-2 bg-orange-500 text-white py-2 px-4 rounded-lg hover:bg-orange-600 transition-colors font-medium"
                >
                  <User size={18} />
                  Connexion
                </Link>
            ...
            <form onSubmit={handleSearch} className="container mx-auto">
              <div className="relative max-w-2xl mx-auto">
                <input
                  ...
                  className="w-full py-3 px-4 pr-12 rounded-lg border border-gray-200 focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-200"
                  autoFocus
                />
                <button
                  type="submit"
                ...
                {!isAuthenticated && (
                  <li className="pt-4">
                    <Link
                      to="/login"
                      onClick={() => setIsOpen(false)}
                      className="block py-3 px-4 bg-orange-500 text-white text-center rounded-lg hover:bg-orange-600 transition-colors font-medium"
                    >
                      Connexion
                    </Link>
                  </li>
